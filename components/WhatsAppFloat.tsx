...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-24 right-6 z-30 items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.5)] hover:bg-[#20b858] hover:scale-110 active:scale-95 transition-all duration-200"
    >
