...
const BRAND_VIDEO_SRC =
  "https://res.cloudinary.com/dptyfvwyo/video/upload/so_2,eo_4/l_video:mashakshustermanbrand_vxbk4e,so_7,eo_32,fl_splice/f_mp4,q_auto/v1783165404/mashakshustermanbrand_vxbk4e.mp4";
const BRAND_POSTER =
